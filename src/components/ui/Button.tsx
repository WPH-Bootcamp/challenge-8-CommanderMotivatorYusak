...
export const Button = ({ 
  ...
  // Base style Tailwind v4
  const baseStyle = "font-medium rounded-xl transition-all duration-200 active:scale-95 flex items-center justify-center gap-2";
  
  // Varian warna sesuai desain Figma kamu
  const variants = {
    primary: "bg-[#FF6B35] text-white hover:bg-[#e05a2b]",
    secondary: "bg-[#18181C] text-white border border-gray-800 hover:bg-[#222228]"
  };
